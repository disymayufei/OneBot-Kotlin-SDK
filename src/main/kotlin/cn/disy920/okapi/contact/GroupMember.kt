...
import cn.disy920.okapi.contact.GroupMember.Role.*
import cn.disy920.okapi.message.chain.MessageChain
import cn.disy920.okapi.packet.api.friend.SendTempMsgPacket
import cn.disy920.okapi.packet.api.group.KickGroupMemberPacket
import cn.disy920.okapi.packet.api.group.SetMemberNameCardPacket
...
class GroupMember(
    ...
    /**
     * 尝试返回群名片，并在群名片为空的时候返回其QQ昵称
     * @return 群名片或昵称
     */
    fun getNameCardOrNick(): String {
        return nameCard.ifBlank { nickName }
    }
